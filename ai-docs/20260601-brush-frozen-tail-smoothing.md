...
> EMA + 死区模型，见 [ai-docs/20260613-brush-procreate-smoothing.md](20260613-brush-procreate-smoothing.md)。本文档**只剩
...
> 决定与论证见 **[ai-docs/20260604-stroke-smoother-time-gate.md](20260604-stroke-smoother-time-gate.md)**。一句话演进：
>
...
>
> 配套阅读：[20260529-brush-architecture.md](20260529-brush-architecture.md)（wash/buildup 算子）、
> [20260530-streamline-velocity-math.md](20260530-streamline-velocity-math.md)（现状平滑，注意已漂移，见下）、
> [20260527-brush-density-wave.md](20260527-brush-density-wave.md)（spacing 连续性的前车之鉴）。
...
2. **自适应其实已经死了（doc 漂移）**：
   - [20260530-streamline-velocity-math.md](20260530-streamline-velocity-math.md) 写 `adapt = streamline`、
...
`globalAlpha = user.opacity`，见 [20260529-brush-architecture.md](20260529-brush-architecture.md) 的
...
1. **`accumDist` 跨界连续**：spacing 累积量要在"tail stamp 转正为 frozen"时无缝接上，
   否则冻结瞬间疏密跳一下（参 [20260527-brush-density-wave.md](20260527-brush-density-wave.md)）。
