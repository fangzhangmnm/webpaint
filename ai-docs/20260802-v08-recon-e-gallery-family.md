...
- **收敛已拍板未落地**（memory：锚 JRP + ADR-0019 显式版本迁移 / 0020 dirty 双轨 / 0021 app 四面不碰 kv，store 系 ADR 2026-08-13 起在 20260813 internal-store/ai-docs/adr/，家族级仍在 MyPWAPatterns/docs/adr/）。
