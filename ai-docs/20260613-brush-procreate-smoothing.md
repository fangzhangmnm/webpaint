...
> as-of v251 / 2026-06-13。取代 `20260601-brush-frozen-tail-smoothing.md`（弧长二次 WLS quad）与
> `20260604-stroke-smoother-time-gate.md`（时间门）。依据：用户 `ai-docs/20260613-brush-proposal.md` 最终节。
...
**经验（为什么走了四版弯路）见 `ai-docs/20260613-lessons-brush-smoothing.md`。**
