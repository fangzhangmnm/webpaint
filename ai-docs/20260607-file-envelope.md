...
> 身份改 **path/name、零注册表**。见 [20260607-sync-identity-decision.md](20260607-sync-identity-decision.md)。
...
> Canonical cross-app spec: `../../20260601 MyPWAPatterns/docs/20260607-file-envelope.md`. This is WebPaint's pilot implementation + slicing. WebPaint is name-identified end-to-end today (no doc GUID); this brings ADR-0011 GUID identity in via a **tail-readable EOCD-comment trailer**, robust to legacy/foreign files.
