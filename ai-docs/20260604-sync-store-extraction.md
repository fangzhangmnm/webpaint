...
> 上游需求：MyPWAPatterns `ai-docs/20260531-sync-library-spec.md`（RFC）+ `ai-docs/MASTER.md §A`（红线）。
> 架构 review：MyPWAPatterns `ai-docs/reports/20260604-webpaint-architecture-review.html` 候选 1。
...
## 故障注入 + Store 验收红线（B 之后补，来自 20260604-potential-bugs.md）
