...
- `ai-docs/20260722-test-charter.md`：8 条历史 bug → 根因 → 新架构哪条保证杀死它（含
...
真机，中途不插验收**——见 ai-docs/20260722-v04-s7-session-handoff.md 的 Sequencing 节。）

### S5 · selection-mask tile 化 + 蚂蚁线深模块 ✅ 已落 v0.4.6 并 merge main（未真机；报告 = ai-docs/20260722-v04-s5-selection-tiles.md）
...
### S6 · float 层入 workpiece ✅ 已落 v0.4.7 并 **merge main（80bedc1，2026-07-22）**，未真机；报告 = ai-docs/20260722-v04-s6-float-workpiece.md。⚠ 行为变化：transform 期 Ctrl+Z=history、reject=identity 写回 stamp 保留、lift 即清选区——详报告 §2。下一片 = **S7，须先真机验完 batch1+S5+S6 再动 + 单独轻量 plan**）
**S5 交接给本片的硬约束**（详 ai-docs/20260722-v04-s5-selection-tiles.md）：
...
### S8 · 编辑逻辑迁移 ✅ 已落 v0.4.9（分支 worktree-v04-s8-s9-edit-migration，未 merge 未真机；报告 = ai-docs/20260722-v04-s8-edit-migration.md）
...
### S9 · 日落 + 改名 ✅ 已落 v0.4.10（同分支；体重合同未达标，诚实交代见 ai-docs/20260722-v04-s9-sunset-weight.md §2；下一棒 = 真机总批，交接 = ai-docs/20260722-v04-s8-s9-session-handoff.md）
...
1. 读 `journal/20260721 Architecture.md`（spec，人类 pin）→ 本文 → `ai-docs/20260722-test-charter.md`。
