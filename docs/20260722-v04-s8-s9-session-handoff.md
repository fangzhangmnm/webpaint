...
> 上一棒交接 = `docs/20260722-v04-s7-session-handoff.md`（其 Sequencing 拍板已执行完毕）。
...
- **S8 编辑逻辑迁移** = `docs/20260722-v04-s8-edit-migration.md`（plan+报告一体）：
...
- **S9 日落+体重** = `docs/20260722-v04-s9-sunset-weight.md`：
...
- 总单 = `docs/20260722-v04-device-test-batch.md`（§0–§9 旧积压 + **§10 S8 / §11 S9 新增**）。
