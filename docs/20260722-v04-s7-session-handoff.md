...
施工图 = `docs/20260722-v04-batch1-handoff.md` §4-S8 + `docs/20260722-v04-s7-render-tree.md` §3
...
- 总单 = `docs/20260722-v04-device-test-batch.md`。**S8/S9 的新增待验项追加进总单**
...
2. `docs/20260722-v04-batch1-handoff.md` — 路线图 + 现状地图（S5/S6/S7 均已标 ✅ merged）。
3. `docs/20260722-v04-s7-render-tree.md` — S7 报告（§3 = S8 交接点：sliceRegionToTiles/
   registerPair 消费口、吸管/导出现状、选区 mask 现状）。
4. `docs/20260722-test-charter.md` — 历史 bug → 架构保证映射（H7 液化 RED 待 S8 转绿）。
