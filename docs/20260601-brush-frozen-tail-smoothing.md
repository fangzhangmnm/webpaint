...
> EMA + 死区模型，见 [docs/20260613-brush-procreate-smoothing.md](20260613-brush-procreate-smoothing.md)。本文档**只剩
...
> 决定与论证见 **[docs/20260604-stroke-smoother-time-gate.md](20260604-stroke-smoother-time-gate.md)**。一句话演进：
>
