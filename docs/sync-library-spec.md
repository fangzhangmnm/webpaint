...
> 状态：**需求整理阶段**。设计 / 实现未开始。
>
> 前置阅读：[gallery-cloud-trash-design.md](gallery-cloud-trash-design.md)
...
参考 WebPaint v141-v146 设计（见 [gallery-cloud-trash-design.md](gallery-cloud-trash-design.md) §2）：
