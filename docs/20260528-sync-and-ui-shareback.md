...
> 相关 doc：[20260527-persistence-and-encryption-shareback.md](20260527-persistence-and-encryption-shareback.md)（更早一版的核心思想，仍然有效）
...
- **register 写模块顶层，不要塞 `window.load`**。app.js 用 dynamic `import()` 加载时
  ...
  → iPad PWA 加主屏后断网"找不到服务器"。详见 [20260526-pwa-update-detection.md §0](20260526-pwa-update-detection.md)
