...
import { mergeFolders, emptyFolder, normalizeFolder } from "./folder-merge.js";
...
const is412 = (e) => e && (e.name === "CloudConflictError" || e.status === 412);
 ...
 */
export function createFolderFlow(cfg) {
