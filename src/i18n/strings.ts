...
export const S = {
  ...
  "sc.fillMode":        { zh: "油漆桶（填充工具）", en: "Paint bucket (fill tool)", ja: "塗りつぶしツール" },
  ...
  "la.invertShort":  { zh: "反选", en: "Invert selection", ja: "選択を反転" },
  "la.clearPixels":  { zh: "清除选区内像素", en: "Clear pixels in selection", ja: "選択範囲のピクセルを消去" },
  "la.duplicate":    { zh: "复制选区到新层", en: "Duplicate selection to new layer", ja: "選択範囲を新規レイヤーに複製" },
  "la.moveToLayer":  { zh: "选区移动到新层", en: "Move selection to new layer", ja: "選択範囲を新規レイヤーへ移動" },
