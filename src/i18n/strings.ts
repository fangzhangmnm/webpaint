...
export const S = {
  ...
  "fm.toggle":       { zh: "填充模式：选区实时预览填色，✓ 落层", en: "Fill mode: live fill preview in selection; ✓ commits", ja: "塗りつぶしモード：選択範囲にプレビュー、✓で確定" },
  "fm.commit":       { zh: "填充并清除选区", en: "Fill and clear selection", ja: "塗りつぶして選択解除" },
  "fm.cancel":       { zh: "退出填充模式（丢弃预览）", en: "Exit fill mode (discard preview)", ja: "塗りつぶしモード終了（破棄）" },
  ...
  "sc.fillMode":        { zh: "魔棒填色（选区填充模式）", en: "Magic-wand fill (fill mode)", ja: "自動選択で塗りつぶし" },
