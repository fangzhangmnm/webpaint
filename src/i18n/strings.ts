...
export const S = {
  ...
  "tool.bucket":    { zh: "油漆桶 (G)",        en: "Paint bucket (G)", ja: "塗りつぶし (G)",       tok: "ilo pi telo kule (G)" },
  ...
  "menu.docGrid":          { zh: "主栅格（对齐网格）", en: "Main grid (alignment)", ja: "メイングリッド（整列）" },
  "nd.grp.painting":    { zh: "绘画", en: "Painting", ja: "ペイント" },
  "nd.grp.print":       { zh: "打印 · 300dpi", en: "Print · 300dpi", ja: "印刷 · 300dpi" },
  "nd.grp.pixel":       { zh: "像素画", en: "Pixel art", ja: "ドット絵" },
  "nd.o1920":           { zh: "1920 × 1080（横）", en: "1920 × 1080 (landscape)", ja: "1920 × 1080（横）" },
  "nd.o1080":           { zh: "1080 × 1920（竖）", en: "1080 × 1920 (portrait)", ja: "1080 × 1920（縦）" },
  ...
  "sc.bucket":          { zh: "油漆桶", en: "Paint bucket", ja: "塗りつぶし" },
  ...
  "bk.toolbar":      { zh: "油漆桶设置", en: "Paint bucket settings", ja: "塗りつぶし設定" },
  "bk.nothingToFill":   { zh: "这里没有可填充的区域", en: "Nothing to fill here", ja: "ここに塗りつぶせる領域がありません" },
  "bk.outsideSelection": { zh: "填充区域在选区之外", en: "Fill area is outside the selection", ja: "塗りつぶし領域が選択範囲の外です" },
  ...
  "ss.pushNotDone": { zh: "没能推送到云端：{name}（离线或有冲突未解决，文件仍在本地）", en: "Couldn't push to cloud: {name} (offline or unresolved conflict; the file is still local)", ja: "クラウドに送信できませんでした：{name}（オフラインまたは未解決の競合。ファイルはローカルにあります）" },
  ...
  "tm.resetRackTitle": { zh: "还原内置笔刷？", en: "Restore built-in brushes?", ja: "内蔵ブラシを復元しますか？" },
  "tm.resetRackBody": { zh: "把内置笔刷恢复成出厂设置，并排到各分组最前。你自己新建或导入的笔刷不会被删除；只有内置笔上的改动会被覆盖。", en: "Restores the built-in brushes to their factory settings and moves them to the top of each folder. Your own brushes are not deleted \u2014 only edits made to built-in brushes are overwritten.", ja: "内蔵ブラシを工場出荷時の設定に戻し、各フォルダーの先頭に並べ替えます。自作・読み込んだブラシは削除されません。内蔵ブラシへの変更のみ上書きされます。" },
  "tm.rackRestored": { zh: "已还原 {count} 支内置笔刷", en: "Restored {count} built-in brushes", ja: "内蔵ブラシ {count} 本を復元しました" },
  ...
  "br.rackRestored": { zh: "已还原 {n} 支内置笔刷", en: "Restored {n} built-in brushes", ja: "内蔵ブラシ {n} 本を復元しました" },
  "br.rackRestoreFailed": { zh: "内置笔刷数据没加载到，还原已取消（检查网络后重试）", en: "Built-in brush data unavailable \u2014 restore cancelled (check your connection and retry).", ja: "内蔵ブラシのデータを読み込めず、復元を中止しました（通信を確認して再試行）" },
  ...
  "br.refreshed": { zh: "笔架已与云端同步", en: "Brush rack synced with cloud", ja: "ブラシラックをクラウドと同期しました" },
  "br.refreshFailed": { zh: "笔架刷新未完成（{status}）", en: "Brush rack refresh incomplete ({status})", ja: "ブラシラックの更新が完了しませんでした（{status}）" },
  "br.refreshing": { zh: "正在从云端刷新笔架…", en: "Refreshing rack from cloud…", ja: "クラウドからブラシラックを更新中…" },
  "br.resetRackTitle": { zh: "还原内置笔刷？", en: "Restore built-in brushes?", ja: "内蔵ブラシを復元しますか？" },
  "br.resetRackMsg": { zh: "把内置笔刷恢复成出厂设置，并排到各分组最前。你自己新建或导入的笔刷不会被删除。", en: "Restores the built-in brushes to their factory settings and moves them to the top of each folder. Your own brushes are not deleted.", ja: "内蔵ブラシを工場出荷時の設定に戻し、各フォルダーの先頭に並べ替えます。自作・読み込んだブラシは削除されません。" },
