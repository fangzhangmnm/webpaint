...
138 icons · 提取自家族图标库 `../20260708 SVG Icons/icons.svg` · 由 `extract-icons.py` 生成，别手改。
...
| name | 说明 |
|------|------|
| `add-to-home-screen` | 添加到主屏幕:圆角方框(16 见方 rx4.6) + 居中加号(长 7.2) —— 甲方 20260821 指定「iOS 分享菜单那个 框里加号」的形式, 候选 1 号入库; 落选:放大版/小圆角版/竖手机框版/右下角徽标版 |
| `database` | — |
